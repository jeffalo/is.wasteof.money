const items  = [
    ...
    {name: 'food', isWaste: 'custom', custom: "depends', explanation: 'You need it to live, but... it's expensive sometimes... so, kinda? sometimes?'}
    {name: 'scratch', isWaste: 'false', explanation: "it's free"}
    {name: 'github', isWaste: 'custom': "it's free unless you have pro"}
